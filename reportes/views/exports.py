...
def exportar_financiero_pdf(request):
    ...
    ranking_dia_revenue = get_ranking_dia_revenue(start_dt, end_dt)
    
    # CAPTURAR PARÁMETROS DE ORDENAMIENTO DESDE GET
    revpas_order_col = request.GET.get('revpas_order_col', '1')
    revpas_order_dir = request.GET.get('revpas_order_dir', 'desc')
    dia_order_col = request.GET.get('dia_order_col', '1')
    dia_order_dir = request.GET.get('dia_order_dir', 'desc')
    detalle_order_col = request.GET.get('detalle_order_col', '2')
...
def exportar_operativo_pdf(request):
    ...
    horarios_order_col = request.GET.get('horarios_order_col', '5')
    ...
    tiene_filtros_personalizados = any([
        ...
        horarios_order_col != '5' or horarios_order_dir != 'desc',
